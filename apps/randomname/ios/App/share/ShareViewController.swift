...
//  share
//
//  Created by Remco on 04/08/2024.
//
...
class ShareViewController: SLComposeServiceViewController {
    ...
    private func sendData() {
        ...
        var urlComps = URLComponents(string: "com.strive.journal://")!
    ...
    fileprivate func createSharedFileUrl(_ url: URL?) -> String {
        ...
        let copyFileUrl =
        fileManager.containerURL(forSecurityApplicationGroupIdentifier: "group.com.strive.journal")!
