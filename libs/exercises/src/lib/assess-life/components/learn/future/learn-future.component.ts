...
@Component({
  standalone: true,
  selector: '[form][interval] strive-assess-life-learn-future',
  templateUrl: './learn-future.component.html',
  styleUrls: ['./learn-future.component.scss'],
...
export class AssessLifeLearnFutureComponent {
