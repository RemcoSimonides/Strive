...
@Component({
  standalone: true,
  selector: '[form][interval] strive-assess-life-learn-past',
  templateUrl: './learn-past.component.html',
  styleUrls: ['./learn-past.component.scss'],
...
export class AssessLifeLearnPastComponent {
