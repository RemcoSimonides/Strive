...
@Component({
  standalone: true,
  selector: '[form][interval] strive-assess-life-environment-future',
  templateUrl: './environment-future.component.html',
  styleUrls: ['./environment-future.component.scss'],
...
export class AssessLifeEnvironmentFutureComponent {
