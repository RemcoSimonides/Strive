...
@Component({
  standalone: true,
  selector: '[form][interval] strive-assess-life-environment-past',
  templateUrl: './environment-past.component.html',
  styleUrls: ['./environment-past.component.scss'],
...
export class AssessLifeEnvironmentPastComponent {
