...
@Component({
  standalone: true,
  selector: '[form][interval] strive-assess-life-explore-past',
  templateUrl: './explore-past.component.html',
  styleUrls: ['./explore-past.component.scss'],
...
export class AssessLifeExplorePastComponent {
