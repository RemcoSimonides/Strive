...
@Component({
  standalone: true,
  selector: '[form][interval] strive-assess-life-explore-future',
  templateUrl: './explore-future.component.html',
  styleUrls: ['./explore-future.component.scss'],
...
export class AssessLifeExploreFutureComponent {
